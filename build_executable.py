...
def check_requirements():
    ...
    try:
        ...
        print("[ERRO] PyInstaller não encontrado. Instalando...")
...
def build_executable():
    ...
    cmd = [
        ...
        "--add-data=yupoo_gui_downloader.py;.",
        "--add-data=yupoo_advanced_downloader.py;.",
        "--add-data=yupoo_simple_cover_downloader.py;.",
    ...
    try:
        ...
        print("[OK] Executável criado em: dist/YupooDownloader.exe")
        ...
        if os.path.exists("dist/YupooDownloader.exe"):
            ...
            print("[OK] Executável copiado para pasta raiz")
            
            # Mostrar tamanho do arquivo
            size_mb = os.path.getsize("YupooDownloader.exe") / (1024 * 1024)
            print(f"[OK] Tamanho do executável: {size_mb:.1f} MB")
        
    except subprocess.CalledProcessError as e:
        print(f"[ERRO] Erro durante a compilação: {e}")
        return False
